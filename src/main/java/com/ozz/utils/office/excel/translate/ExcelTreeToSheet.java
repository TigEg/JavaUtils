...
public class ExcelTreeToSheet {
  ...
  private static <T> Sheet createSheet(Workbook workbook, String sheetName, List<T> treeList, List<String> props, String childProp, List<CellStyle> headStyles,
      CellStyle bodyStyle) {
  ...
  private static <T> void createClassSheet(Sheet sheet, List<CellStyle> headStyles, CellStyle bodyStyle, T model, List<String> props, String childProp,
  ...
  private static <T> void createClassMess(Sheet sheet, List<CellStyle> headStyles, CellStyle bodyStyle, T model, List<String> props, String childProp,
      int level, boolean createNewRw) {
    Row row;
    if (createNewRw) {
